...
|                    | 사용자 제공 데이터 파일 | 📄 역삼동*보도별*일조시간.csv / 역삼동*보도일도_10m단위*정리.xlsx |
...
- [ ] Leaflet 지도 통합
- [ ] 검색창 UI (출발지, 도착지 입력)
- [ ] PostgreSQL + PostGIS 데이터베이스 설정
- [ ] 기본 지도 데이터 로드 (OpenStreetMap)

### Phase 2: 경로 계산 엔진 (2~3주)
...
### Phase 3: 그늘 길 알고리즘 (3~4주)

- [ ] 건물 정보 데이터 import (강남구청 GIS)
- [ ] 가로수 정보 데이터 import (서울시 공공데이터)
- [ ] 태양 위치 계산 구현
- [ ] 그늘 점수 계산 엔진 구현
- [ ] 그늘을 고려한 경로 최적화 알고리즘
